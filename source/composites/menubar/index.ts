...
export function ThemeMenubar(
    theme: ITheme,
    declarations: IWidgetDeclaration<HTMLElement, ThemeMenubarOptions & ICommonAttributes>
): IWidgetNode<any, any> {

    const {
        declaration,
        extended
    } = declarationExplodes<IWidgetDeclaration<HTMLElement, ThemeMenubarOptions & ICommonAttributes>, ThemeMenubarOptions>(
        declarations, ['variant', 'fixed', 'children', 'start', 'end', 'direction'],
    )
