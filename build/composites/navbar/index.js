import { declarationExplodes, Style, Navbar, Row, createRef, Layer, } from "@protorians/widgets";
export function ThemeNavbar(theme, declarations) {
    const { declaration, extended } = declarationExplodes(declarations, ['children', 'direction', 'indicators', 'styles', 'separator']);
