import { Button, Color, declarationExplodes, ObjectSize, Style, } from "@protorians/widgets";
import { LayerVariant } from "../../enums.js";
import { getObjectSize } from "../../utilities/index.js";
export function ThemeButton(theme, declarations) {
    const { declaration, extended } = declarationExplodes(declarations, ['variant', 'outline', 'before', 'after', 'size']);
    ...
    let padding = compute.padding;
    let fontSize = compute.fontSize;
    if (extended.size) {
