import { Color, declarationExplodes, Style, ObjectElevation, Navbar, Row } from "@protorians/widgets";
import { LayerVariant } from "../../enums.js";
export function ThemeBellowMenuBar(theme, declarations) {
    const { declaration, extended } = declarationExplodes(declarations, ['variant', 'fixed', 'children', 'start', 'end', 'direction', 'styles']);
    ...
    return Navbar({ ...declaration, children });
}
